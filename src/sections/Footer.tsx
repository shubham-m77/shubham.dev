...
const footerLinks = [
  ...
  },
  {
    ...
    href: "https://github.com/shubham-m77/",
  },
  {
    title: "Resume",
    icon:
...
export const Footer = () => {
  return <footer className="relative z-10 overflow-x-clip pointer-events-auto">
    <div className="absolute h-[400px] -z-10 w-[1600px] bottom-0 left-1/2 -translate-x-1/2 bg-blue-700/40 dark:bg-blue-700/30 [mask-image:radial-gradient(50%_50%_at_bottom_center,black,transparent)] "></div>
    <div className="px-4 md:px-14 lg:px-20">
      <div className="border-t justify-center md:justify-between gap-8 md:gap-0  flex flex-col-reverse  md:flex-row items-center border-blue-900/15 dark:border-white/15 py-6 text-sm">
        <div className="text-gray-900 dark:text-white/80"><span>&copy; 2025 All Rights Reserved</span></div>
        <p className="bg-gradient-to-r from-blue-900 to-blue-700 dark:from-[#74ebd5] dark:to-[#ACB6E5] text-semibold bg-clip-text text-transparent">Made with <span className="text-[#ff0000]">❤️</span> by Shubham</p>
        <nav className="flex justify-center flex-wrap md:flex-row gap-6 z-10 relative">
          {footerLinks.map(link =>
            <Link
              ...
              className="font-medium gap-1.5 inline-flex items-center z-10 relative "
            >
              <span className="size-6 text-gray-900 dark:text-gray-50">{link.icon}</span>
            </Link>
          )}
        </nav>
      </div>

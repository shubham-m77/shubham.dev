...
>
  ...
  className={`
    ...
    ${isMenuOpen ? "flex opacity-100 scale-100 items-center justify-center translate-y-0 bg-black/10 dark:bg-black/50 backdrop-blur-md rounded-2xl" : "opacity-0 scale-95 -translate-y-5 pointer-events-auto"}
